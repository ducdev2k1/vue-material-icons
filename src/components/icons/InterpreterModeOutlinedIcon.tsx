...
export default defineComponent({
  name: 'InterpreterModeOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
