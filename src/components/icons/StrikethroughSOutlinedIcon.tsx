...
export default defineComponent({
  name: 'StrikethroughSOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
