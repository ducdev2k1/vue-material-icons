...
export default defineComponent({
  name: 'PestControlRodentRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
