...
export default defineComponent({
  name: 'LocalConvenienceStoreRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
