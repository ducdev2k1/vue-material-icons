...
export default defineComponent({
  name: 'HistoryToggleOffOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
