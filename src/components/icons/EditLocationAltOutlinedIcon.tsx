...
export default defineComponent({
  name: 'EditLocationAltOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
