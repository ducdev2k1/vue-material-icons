...
export default defineComponent({
  name: 'SlowMotionVideoRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
