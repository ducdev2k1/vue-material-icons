...
export default defineComponent({
  name: 'FaceRetouchingOffOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
