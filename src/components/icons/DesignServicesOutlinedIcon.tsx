...
export default defineComponent({
  name: 'DesignServicesOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
