...
export default defineComponent({
  name: 'ConnectWithoutContactRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
