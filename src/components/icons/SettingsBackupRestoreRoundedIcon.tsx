...
export default defineComponent({
  name: 'SettingsBackupRestoreRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
