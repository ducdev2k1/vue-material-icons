...
export default defineComponent({
  name: 'WifiTetheringErrorRoundedRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
