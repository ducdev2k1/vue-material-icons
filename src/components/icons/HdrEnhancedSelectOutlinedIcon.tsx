...
export default defineComponent({
  name: 'HdrEnhancedSelectOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
