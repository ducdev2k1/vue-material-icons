...
export default defineComponent({
  name: 'ThreeDRotationOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
