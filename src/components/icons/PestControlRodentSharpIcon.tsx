...
export default defineComponent({
  name: 'PestControlRodentSharpIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
