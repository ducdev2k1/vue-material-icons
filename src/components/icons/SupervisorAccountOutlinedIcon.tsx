...
export default defineComponent({
  name: 'SupervisorAccountOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
