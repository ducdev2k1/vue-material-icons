...
export default defineComponent({
  name: 'EditNotificationsRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
