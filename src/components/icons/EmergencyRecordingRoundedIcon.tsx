...
export default defineComponent({
  name: 'EmergencyRecordingRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
