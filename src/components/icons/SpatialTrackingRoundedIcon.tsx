...
export default defineComponent({
  name: 'SpatialTrackingRoundedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
