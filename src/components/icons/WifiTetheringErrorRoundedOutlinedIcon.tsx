...
export default defineComponent({
  name: 'WifiTetheringErrorRoundedOutlinedIcon',
  props: {
    size: [String, Number],
    color: String,
    viewBox: String,
