      ...
      useIconRender(
        [
          ...
          },
          {
            ...
            props: {
              rule: 'evenodd',
              d: 'M24 21.796h-1.34v-1.308h-.031C22.046 21.497 21.189 22 20.056 22c-.806 0-1.451-.22-1.936-.659-.485-.438-.727-1.027-.727-1.768 0-1.556.92-2.465 2.76-2.727l2.508-.352c0-1.415-.575-2.123-1.723-2.123-1.008 0-1.917.34-2.728 1.02V14.02c.245-.185.664-.364 1.258-.535.593-.171 1.12-.258 1.584-.258 1.965 0 2.949 1.043 2.949 3.128v5.44zm-1.34-4.232-2.024.287c-.692.098-1.176.262-1.455.494-.277.232-.416.606-.416 1.123 0 .42.15.756.45 1.009.299.253.683.38 1.15.38.666 0 1.214-.235 1.647-.703.433-.468.65-1.053.65-1.756v-.834h-.001zM25.7 24l1.295-4H25.7l-.953 4h.953z',
              fill: '#33C481',
            },
          },
          {
