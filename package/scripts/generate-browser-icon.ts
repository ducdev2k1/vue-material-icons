...
const SVG_DIR = path.resolve('src/assets/browser');
const OUTPUT_DIR = path.resolve('src/components/Browser');
...
// Tạo name componenet
const createComponentName = (name: string) => `Browser${pascalCase(name)}`;
